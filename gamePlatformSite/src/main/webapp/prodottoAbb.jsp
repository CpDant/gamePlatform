...
<head>
<meta charset="utf-8">
<title><%=abbBean.getNomeUnivoco()%></title>
...
<body>
	...
	<div class="container">
		<h2 class="text-center"><%=abbBean.getNomeUnivoco()%></h2>
	</div>
	<div class="container mt-5 mb-5" id="product-section">
		
		<div class="row text-center">
			<div class="col-md-6 border-end">
				<img class="image-responsive" width="70%" src="ImageServlet?immagine=<%=abbBean.getNomeUnivoco()%>.jpg" alt="image">
			</div>
			<div class="col-md-6">
				<h4>Specifiche abbonamento:</h4>
				<br/>

...
/**
 * Servlet implementation class ServletAdministrators
 */
@WebServlet("/ServletAdministrators")
public class ServletAdministrators extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletAdministrators() {
        super();
    }
